...
BOT_TOKEN = getenv("BOT_TOKEN", "7721681605GhVqWWFF920c0WVvV8qrG4NNLJAVrRBus")

MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://Sezar:p@cluster0.gp7vh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
